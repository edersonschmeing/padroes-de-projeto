package factory_method.java.exemplo_transporte.depois_do_padrao;

import factory_method.java.exemplo_transporte.depois_do_padrao.modelo.Transporte;
import factory_method.java.exemplo_transporte.depois_do_padrao.factory.AereoFactory;
import factory_method.java.exemplo_transporte.depois_do_padrao.factory.DutoviarioFactory;
import factory_method.java.exemplo_transporte.depois_do_padrao.factory.FerroviarioFactory;
import factory_method.java.exemplo_transporte.depois_do_padrao.factory.HidroviarioFactory;
import factory_method.java.exemplo_transporte.depois_do_padrao.factory.RodoviarioFactory;
import factory_method.java.exemplo_transporte.depois_do_padrao.factory.TransporteFactory;
